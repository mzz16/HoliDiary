...
@Controller
public class jp_WriteController {
	...
	// 게시글 목록 불러오기 - 리스트 형식
	@RequestMapping(value = "/jp_post-list", method = RequestMethod.GET)
	...
	// 게시글 목록 불러오기 - 오래된순
	@RequestMapping(value = "/jp_post-list.past", method = RequestMethod.GET)
	...
	// 게시글 목록 불러오기 - 추천순
		@RequestMapping(value = "/jp_post-list.recommend", method = RequestMethod.GET)
		public String recommendList(HttpServletRequest req, DiaryPost p, Diary d, @RequestParam("userId") String userId, User u,
			...
			req.setAttribute("popupContentPage", "../jp_mj_write/jp_post_list_recommend.jsp");
			return "jp_ksm_main/jp_popup";
		}
	
	// 게시글 목록 불러오기 - 갤러리 형식
	@RequestMapping(value = "/jp_post-Gallery", method = RequestMethod.GET)
	public String GalleryGo(HttpServletRequest req, DiaryPost p, Diary d, @RequestParam("userId") String userId, User u,
		...
		req.setAttribute("popupContentPage", "../jp_mj_write/jp_post_gallery.jsp");
		return "jp_ksm_main/jp_popup";
	}
	
	// 게시글 목록 불러오기 - 갤러리 형식 - 오래된순
	@RequestMapping(value = "/jp_post-Gallery.past", method = RequestMethod.GET)
	public String GalleryPastGo(HttpServletRequest req, DiaryPost p, Diary d, @RequestParam("userId") String userId, User u,
		...
		req.setAttribute("popupContentPage", "../jp_mj_write/jp_post_gallery_past.jsp");
		return "jp_ksm_main/jp_popup";
	}
	
	// 게시글 목록 불러오기 - 갤러리 형식 - 추천순
	@RequestMapping(value = "/jp_post-Gallery.recommend", method = RequestMethod.GET)
	public String GalleryRecommendGo(HttpServletRequest req, DiaryPost p, Diary d, @RequestParam("userId") String userId, User u,
		...
		req.setAttribute("popupContentPage", "../jp_mj_write/jp_post_gallery_recommend.jsp");
		return "jp_ksm_main/jp_popup";
	}

	// 카테고리별 목록 불러오기 - 리스트 형식
	// 게시글 목록 불러오기 - 리스트 형식
	@RequestMapping(value = "/jp_category-list", method = RequestMethod.GET)
	public String categoryListGo(HttpServletRequest req, DiaryPost p, Diary d, @RequestParam("userId") String userId, User u,
		...
		req.setAttribute("popupContentPage", "../jp_mj_write/jp_post_category_list.jsp");
		return "jp_ksm_main/jp_popup";
	}
	
	// 게시글 목록 불러오기 - 갤러리 형식
		@RequestMapping(value = "/jp_category-gallery", method = RequestMethod.GET)
		public String categoryGalleryGo(HttpServletRequest req, DiaryPost p, Diary d, @RequestParam("userId") String userId, User u,
			...
			req.setAttribute("popupContentPage", "../jp_mj_write/jp_post_category_gallery.jsp");
			return "jp_ksm_main/jp_popup";
		}

	// 게시글 상세보기
	@RequestMapping(value = "/jp_post.detail.go", method = RequestMethod.GET)
	public String postDetailGo(DiaryPost p, Diary d, @RequestParam("userId") String userId, HttpServletRequest req,
		...
		req.setAttribute("popupContentPage", "../jp_mj_write/jp_post_detail.jsp");

		return "jp_ksm_main/jp_popup";
	}

	// 글쓰기 페이지 바로가기
	@RequestMapping(value = "/jp_write.go", method = RequestMethod.GET)
	public String writeGo(HttpServletRequest req, Diary d, @RequestParam("userId") String userId, User u, Category cate,
		...
		req.setAttribute("popupContentPage", "../jp_mj_write/jp_post_write2.jsp");
		return "jp_ksm_main/jp_popup";
	}
	...
	// 글 등록
	@RequestMapping(value = "/jp_diaryPost.reg.do", method = RequestMethod.POST)
	public String postRegDo(Diary d, @RequestParam("userId") String userId, HttpServletRequest req,
		...
		return "redirect:jp_post.detail.go?postNum=" + pDAO.getPostNum(p) + "&userId=" + userId;
		/*req.setAttribute("popupContentPage", "../mj_write/post_list.jsp");
		return "ksm_main/popup";*/
	}

	// 글 삭제
	@RequestMapping(value = "/jp_diaryPost.delete", method = RequestMethod.GET)
	...
	// 글 수정하러 가기
	@RequestMapping(value = "/jp_diaryPost.update.go", method = RequestMethod.GET)
	public String updateDiaryPost(HttpServletRequest req, Diary d, DiaryPost p, @RequestParam("userId") String userId,
		...
		req.setAttribute("popupContentPage", "../jp_mj_write/jp_post_update.jsp");
		return "jp_ksm_main/jp_popup";
	}

	// 글 수정하기
	@RequestMapping(value = "/jp_diaryPost.update.do", method = RequestMethod.POST)
	...
	// 좋아요
	@ResponseBody
	@RequestMapping(value = "jp_updateLike.do", method = RequestMethod.GET)
	...
	@ResponseBody
	@RequestMapping(value = "jp_checkLike.do", method = RequestMethod.GET)
	...
	// 댓글 등록
	@ResponseBody
	@RequestMapping(value = "/jp_comment.do", method = RequestMethod.GET)
	...
	// 댓글 리스트
	@ResponseBody
	@RequestMapping(value = "/jp_commentList.do", method = RequestMethod.GET, produces = "application/json")
	...
	// 댓글 삭제
	@ResponseBody
	@RequestMapping(value = "/jp_commentDelete.do", method = RequestMethod.GET, produces = "application/json")
	...
	// 댓글수정
	@ResponseBody
	@RequestMapping(value = "/jp_commentUpdate.do", method = RequestMethod.GET, produces = "application/json")
	...
	// 지도 만들기
	@RequestMapping(value = "/jp_map.open", method = RequestMethod.GET)
