...
public class DiaryPostDAO {
	...
	public void regPost(HttpServletRequest req, String userId, MultipartFile mf, String postTitle, String postTxt, String postCategory, String postCountry) {
	...
	public void diaryPostUpdate(DiaryPost p, HttpServletRequest req, String userId) {
