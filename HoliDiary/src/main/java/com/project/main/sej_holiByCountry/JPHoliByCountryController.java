...
@Controller
public class JPHoliByCountryController {
	...
	@RequestMapping(value = "/JPholiByCountry.go", method = RequestMethod.GET)
	...
	@RequestMapping(value = "JPsearch.page.change.holi", method = RequestMethod.GET)
