...
public class PopupController {
	...
	public String popupOpen(HttpServletRequest req, Diary d, User u, Category c, @RequestParam("userId") String userId) {
	...
	public String popupHome(HttpServletRequest req, Diary d, User u, Category c, @RequestParam("userId") String userId) {
	...
	public String popupScedule(HttpServletRequest req, Diary d, User u, Category c, @RequestParam("userId") String userId) {
	...
	public String updateMyPopup(HttpServletRequest req, Diary d, User u, Category c, @RequestParam("userId") String userId) {
	...
	public String updateMyDiary(HttpServletRequest req, Diary d, User u, Category c, @RequestParam("diaryUserId") String userId) {
	...
	public String updateCategory(HttpServletRequest req, Diary d, User u, Category c, @RequestParam("userId") String userId) {
