						...
						<div style="text-align: center;">
							<div class="mypage_myinfo_left">
								...
								<c:otherwise>
									...
									<div class="mypage_myinfo_img_change">
										<label for="mypage_img_file">写真修正</label> <input type="file"
											onchange="readURL(this)" name="userImg" id="mypage_img_file"
											readonly />
									</div>
								</div>
								<div class="mypage_myinfo_social_box">
									<div class="mypage_myinfo_social_title">SNS連動</div>
							...
							<div class="myapge_myinfo_right">
								...
								<div class="myapge_myinfo_right_txt">
									...
									<c:choose>
										<c:when test="${sessionScope.loginUser.userPhoneNumber eq '없음'}">
											<input id="mypage_phone" name="userPhoneNumber" placeholder="電話番号を入力してください。" autocomplete="off">
										</c:when>
										<c:otherwise>
								...
								<div class="myapge_myinfo_right_txt">
									...
									<input type="password" id="mypage_pW" name="userPW" placeholder="現在のパスワード">
								...
								<div class="myapge_myinfo_right_btn_box">
									<button>情報修正</button>
									<button type="button" onclick="deleteUser()">脱退</button>
								</div>
							</div>
						</div>
					</form>
