...
<!-- 좌측 카테고리 리스트 -->
       ...
       <div>
        <a href="post-list?userId=${User.userID}&nowPage=1&cntPerPage=10" class="item-link" id="pageLink">
          <svg class="link-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-list">
            <path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01" />
					...
					<a href="category-list?userId=${User.userID}&nowPage=1&cntPerPage=10&category=${category }" class="item-link il-${status.count }" id="pageLink"> <svg
